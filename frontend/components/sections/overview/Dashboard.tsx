...
import { ArrowRight, MousePointerClick, TrendingUp, Eye, XCircle } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        ...
        <MetricCard
          ...
          label="Dismissed"
          value={metrics ? fmt(metrics.dismissed) : "—"}
          delta="X / backdrop"
          deltaTone="muted"
        />
        <MetricCard
  ...
  return (
    <Card>
      <CardContent className="p-4">
        ...
        >
          {deltaTone === "positive" ? `${delta} vs last week` : delta}
        </div>
      </CardContent>
    </Card>
  );
